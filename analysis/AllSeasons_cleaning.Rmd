...
load(paste0(paste(strsplit(getwd(), split = "/")[[1]][1:5], collapse = "/"), "/table_data.Rdata")) # load table for each season

load(paste0(paste(strsplit(getwd(), split = "/")[[1]][1:5], collapse = "/"), "/number_of_seasons_by_each_club.Rdata")) # load data of seasons number for each club
...
plot1 <- vis_miss(all_seasons, show_perc_col = FALSE) 

# Na visualization in cleaned data
plot2 <- vis_miss(proccessed_data, show_perc_col = FALSE) 
...
file <- paste0(paste(strsplit(getwd(), split = "/")[[1]][1:5], collapse = "/"), "/output/processed_data")
