...
new_scrapedData2023and2024 <- my_F(scrapedData2023and2024, "2023/24")
new_scrapedData2024and2025 <- my_F(scrapedData2024and2025, "2024/25")
...
joined_data_24_25 <- merge(joined_df_24_25, df1 %>% select(club, season24.25), by.x = "Gospodarz", by.y = "club", all.x = TRUE) %>% merge(df1 %>% select(club, season24.25), by.x = "Gość", by.y = "club", all.x = TRUE)
...
joined_data_list <- list(joined_data_12_13, joined_data_13_14, joined_data_14_15, joined_data_15_16, joined_data_16_17, joined_data_17_18,      
                         joined_df_15_16, joined_data_18_19, joined_data_19_20, joined_df_20_21, joined_df_21_22, joined_df_22_23, joined_df_23_24, joined_df_24_25)
